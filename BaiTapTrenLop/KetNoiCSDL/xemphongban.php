...
<?php
	...
	//in tieu de cua bang
	echo'<tr><th>IDPB</th><th>Mota</th><th>Thoigian</th><th>Xem nhan vien</th></tr>';
	while($row=mysqli_fetch_array($result))
	{
	
		echo 
		'<tr><td NAME="idpb">'.$row['IDPB'].'</td><td>'.$row['Mota'].'</td><td>'.
		$row['Thoigian'].
		'</td><td><a href="xemnhanvienphongban.php?idpb='.$row['IDPB'].'">xem thêm...</a></td></tr>';
